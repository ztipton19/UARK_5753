...
```{r}
uark_enrollment$y_lead <- slide_dbl(uark_enrollment$total, mean, .before = 0, .after = 1, .complete = TRUE)

cor(uark_enrollment$total, uark_enrollment$y_lead, use = "complete.obs")

acf(uark_enrollment$total, plot = FALSE)$acf[2]  # [1] is lag-0, [2] is lag-1
